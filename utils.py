...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='UDiff', help='model name')  # Encoder Diff
    ...
    parser.add_argument('--test_data_dir', type=str, default='/home/data/SwitchFusion', help='data path')
    parser.add_argument('--tf_logs_dir', type=str, default='/home/mac-of-ypeng/tf-logs', help='tf_logs path')
